...
{
    public sealed class RuleView : IValidatableObject
    {
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            if (context.Rule.Get(StructureId, Name) != null)
                yield return new ValidationResult("This rule already exists", new[] { "Name" });
        }
    }
}